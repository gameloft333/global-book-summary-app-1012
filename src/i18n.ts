...
const resources = {
  en: {
    translation: {
      appTitle: "Book Summary Generator",
      ...
      summaryChinese: "Summary (CN)",
      summaryEnglish: "Summary (EN)",
      analysisChinese: "Analysis (CN)",
      analysisEnglish: "Analysis (EN)",
  ...
  zh: {
    translation: {
      ...
      analysisChinese: "分析（中文）",
      analysisEnglish: "分析（英文）",
      unknownError: "发生未知错误",
